...
export function LoginButton() {
  ...
  if (status === "loading") {
    return <div className="text-gray-500">Loading authentication...</div>;
  }
  ...
  if (session) {
    return (
      <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded text-sm text-gray-600 w-full overflow-x-auto">
          <p className="font-medium">Session Token (for API calls):</p>
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <button
        ...
        className="flex items-center space-x-2 px-6 py-3 text-white bg-pink-600 rounded-xl hover:bg-pink-700 transition duration-300 shadow-xl transform hover:scale-[1.02]"
      >
        <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
