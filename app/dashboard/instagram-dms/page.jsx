...
const DEFAULT_TOKEN = ""
...
export default function InstagramDMs() {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      console.log(
        `%c[API Call 4] Sending message to IG user via Business Account`,
        "color: #f97316; font-weight: bold;"
      );

      // 👇 Replace with your actual Instagram Business Account ID
      const instagramBusinessId = "178414XXXXXXX";

      const payload = {
        recipient: { id: selectedConversation }, // conversation recipient
      ...
      console.log(
        "%c[API Call 4 Success] Message sent successfully!",
            ...
            {!isReady && !loading && isTokenEntered && conversations.length === 0 ? (
              ...
              conversations.map((c) => (
                <div
                  ...
                  className={`cursor-pointer p-4 border rounded-xl transition duration-150 hover:shadow-md ${selectedConversation === c.id
              ...
              {!selectedConversation ? (
                ...
                !loading && messages.length === 0 ? (
                  ...
                  messages.map((m) => (
                    ...
                    >
                      <div
                        className={`p-3 rounded-2xl max-w-[90%] sm:max-w-[70%] break-words shadow-md transition-all duration-300 ${m.isSender
