                ...
                {selectedPost && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                        <div className="bg-white w-full max-w-md p-6 rounded-2xl shadow-lg relative">
                            ...
                            {insights.length === 0 ? (
                                <p className="text-gray-500 text-center py-10">No insights available for this post.</p>
                            ) : (
                            ...
                            <button
                                onClick={() => setSelectedPost(null)}
                                className="mt-6 bg-blue-600 text-white px-5 py-2 rounded-xl hover:bg-blue-700 w-full"
                            >
                                Close
                            </button>
                        </div>
